...
using TestBlazorLast.Blazor.Server.Services;

namespace TestBlazorLast.Blazor.Server {
    public partial class TestBlazorLastBlazorApplication : BlazorApplication {
        #region Default XAF configuration options (https://www.devexpress.com/kb=T501418)
        static TestBlazorLastBlazorApplication() {
            DevExpress.Persistent.Base.PasswordCryptographer.EnableRfc2898 = true;
            DevExpress.Persistent.Base.PasswordCryptographer.SupportLegacySha512 = false;
            DevExpress.ExpressApp.BaseObjectSpace.ThrowExceptionForNotRegisteredEntityType = true;
        }
        #endregion
        public TestBlazorLastBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void TestBlazorLastBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
